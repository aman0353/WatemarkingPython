Packaging and Deploying watermarking
...
2. Installing the watermarking Package

A. Go to the directory that contains the file setup.py and the subdirectory watermarking. 
...
3. Using the watermarking Package

The watermarking package is on your Python path. To import it into a Python script or 
